...
window.addEventListener("scroll", (e) => {
   ...
   if (this.scrollY > window.screen.height) {
      document.body.style.cssText = `--scrollSecondTop:${
         this.scrollY - window.screen.height
      }px`;
   }

   if (this.scrollY > window.screen.height * 2) {
      document.body.style.cssText = `--scrollThreeTop: ${
         this.scrollY - window.screen.height * 2
      }px`;
   }
});
document.querySelector("mouseover", (e) => {
